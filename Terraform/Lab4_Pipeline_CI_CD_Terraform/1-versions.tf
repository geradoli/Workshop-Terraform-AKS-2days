...
terraform {
  ...
  backend "azurerm" {
    resource_group_name  = "RG-AKSCluster_gdol"         # mettre ici le nom du resource group de vos ressource
    storage_account_name = "storageacoountgdol"      # mettre le nom du compte de stockage créer dans le lab 1
